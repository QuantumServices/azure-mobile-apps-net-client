...
namespace Microsoft.WindowsAzure.MobileServices.Sync
{
    ...
    public interface IMobileServiceSyncTable
    {
        ...
        /// <summary>
        /// Updates the <paramref name="instances"/> in the table.
        /// </summary>
        /// <param name="instances">
        ...
        /// A task that will complete when the update finishes.
        /// </returns>
        Task UpdateAsync(IEnumerable<JObject> instances);
        ...
        /// <summary>
        /// Deletes instances from the table based on the query
        /// </summary>
        /// <param name="query">
        /// A query to find instances to delete
        /// </param>
        /// <returns>
        /// A task that will compelete when the delete finishes.
        /// </returns>
